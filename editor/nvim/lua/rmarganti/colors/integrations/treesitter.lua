...
return {
    -- TSAnnotation = {},
    -- TSBoolean = { fg = a.base },
    -- TSConditional = { fg = a.base, italic = true },
    ...
    -- TSException = { fg = a.base, italic = true },
    TSField = { fg = a.plus2 },
    -- TSFloat = { fg = a.base },
    ...
    -- TSLabel = { fg = a.base, italic = true },
    TSLiteral = { fg = a.plus1 },
    TSMethod = { fg = a.plus2, italic = true },
    ...
    -- TSRepeat = { fg = a.base, italic = true },
    -- TSString = { fg = a.base },
